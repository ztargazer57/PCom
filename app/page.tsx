      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#DDF1FF] via-[#F7FBFF] to-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 md:grid-cols-2 md:px-8 md:py-24">
          ...
          >
            ...
            <h1 className="max-w-2xl text-3xl font-heading font-semibold tracking-wide text-slate-800 sm:text-5xl md:text-6xl lg:text-6xl">
              {pageContent.heroTitle}
            </h1>

            <p className=" max-w-xl font-body text-base leading-8 text-slate-600 md:text-lg">
